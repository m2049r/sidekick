...
public class BluetoothService {
    ...
    private void onConnectionLost() {
        ...
        if (reconnect) return;
//        if (handler != null)
//            handler.obtainMessage(MessageType.TOAST, Toasts.CONNECTION_LOST).sendToTarget();
...
/*
    ...
    static private BluetoothService Instance = null;

    static public String connect(Handler handler) {
        if (Instance != null) {
            disconnect();
        }
