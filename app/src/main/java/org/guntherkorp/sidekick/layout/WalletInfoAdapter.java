...
package org.guntherkorp.sidekick.layout;
...
public class WalletInfoAdapter extends RecyclerView.Adapter<WalletInfoAdapter.ViewHolder> {
    ...
    public interface OnInteractionListener {
        void onInteraction(View view, WalletInfo item);

        boolean onContextInteraction(MenuItem item, WalletInfo infoItem);
    }

    private final List<WalletInfo> infoItems;
    ...
    private static class WalletInfoDiff extends DiffCallback<WalletInfo> {

        public WalletInfoDiff(List<WalletInfo> oldList, List<WalletInfo> newList) {
    ...
    public void setInfos(List<WalletInfo> newItems) {
        if (newItems == null) {
        ...
        final DiffCallback<WalletInfo> diffCallback = new WalletInfoAdapter.WalletInfoDiff(infoItems, newItems);
